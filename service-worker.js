const CACHE_NAME = "deutsch-b1-begleiter-20260623-fotos-20";
const CORE_ASSETS = [
  "./",
  "./?app=deutsch-b1-begleiter-20260623-fotos-20",
  "./index.html",
  "./styles.css?v=20260623fotos20",
  "./app.js?v=20260623fotos20",
  "./manifest.webmanifest?v=20260623fotos20",
  "./service-worker.js",
  "./icon.svg",
  "./icon-192.png",
  "./icon-512.png",
